...
class MainActivity :
    ...
    // Fungsi ini dipanggil otomatis saat user memilih tanggal pada DatePicker Dialog
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            // Event listener saat item pada spinnerCountry dipilih
            spinnerCountry.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
                ...
                override fun onNothingSelected(parent: AdapterView<*>) {
                    // Tulis kode jika tidak ada item yang dipilih
                }
            }
